...
export default function AdminProductDetailPage() {
  ...
  const handleResync = async () => {
    ...
    if (
      !confirm(
        'Обновить товар из данных поставщика? Название, описание и картинка '
          + 'будут перезаписаны данными FK, цены и варианты — обновлены. '
          + 'Ручные правки этих полей потеряются.',
      )
    ) {
      return;
    }
