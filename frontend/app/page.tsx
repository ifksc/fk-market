    ...
    <>
      ...
      <section id="how" className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="grid md:grid-cols-3 gap-4">
          {[
            ['1', 'Выбираете товар', 'VPN, скин, ключ, ИИ-аккаунт, подписка. Удобные фильтры и рейтинги.'],
            ['2', 'Оплачиваете через FKwallet', 'Карта, СБП, кошелёк, крипта — всё в одном окне.'],
            ['3', 'Получаете код мгновенно', 'В личном кабинете и на email. В любой момент можно скачать заново.'],
          ].map(([n, title, text]) => (
            <div
              key={n}
