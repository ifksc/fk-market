...
/**
 * Клиентская обвязка админки: проверка токена, профиль, навигация, logout.
 * Вынесена из app/admin/layout.tsx — layout сделан серверным ради экспорта
 * metadata (noindex). Логика идентична прежнему AdminLayout.
 */
